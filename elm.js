...
Elm.Deck.make = function (_elm) {
   ...
   var create = F3(function (title,author,slides) {    return {id: idify(title),title: title,author: author,slides: slides,history: _U.list([])};});
   var load = F3(function (title,author,slides) {
      var _p2 = author;
      if (_p2.ctor === "Just") {
            return A3(create,title,_p2._0,slides);
         } else {
